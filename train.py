...
def main():
    ...
    parser.add_argument('--bs', type=int, help="relative importance of the auto-balancing self-supervised term" , default=64)
    ...
    parser.add_argument('--raw_bal_term', help="leave unnormalized the auto-balancing self-supervised term" , default=False, action='store_true')
